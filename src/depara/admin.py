...
class DeparaAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Catálogo", {"fields": ("id_catalogo", "id_acesso")}),
        ("Mapeamento de Origem", {"fields": ("codigo_origem", "descricao_origem")}),
        ("Mapeamento de Destino", {"fields": ("codigo_destino", "descricao_destino")}),
        ("Status", {"fields": ("ativo",)}),
        (
            "Metadados",
            {"fields": ("id_depara", "criado_em", "atualizado_em"), "classes": ("collapse",)},
        ),
    )
