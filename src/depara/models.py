...
class DePara(models.Model):
    ...
    id_catalogo = models.ForeignKey(
        CatalogoDePara, on_delete=models.CASCADE, verbose_name="ID Catálogo"
    )

    id_depara_pai = models.ForeignKey(
        "self",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        verbose_name="ID DePara Pai",
        related_name="de_paras_filhos",
        db_column="id_depara_pai",
    )
