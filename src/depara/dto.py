...
class DeparaDto(serializers.ModelSerializer):
...
class DeparaListDto(serializers.ModelSerializer):
    """Simplified serializer for DePara list views."""

    catalogo_tabela = serializers.CharField(source="id_catalogo.tabela_origem", read_only=True)
...
class DeparaDetailDto(serializers.ModelSerializer):
