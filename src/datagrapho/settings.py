...
# Proteções HTTP ficam habilitadas por padrão sempre que DEBUG estiver desligado.
# Os valores continuam configuráveis para ambientes locais e proxies específicos.
